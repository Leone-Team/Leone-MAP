...
public class Saving implements Serializable{
    ...
    public Saving(Set<GameObserver> obsAttached, HashMap<Integer, Item> items, HashMap<String, Room> rooms, Set<Integer> inventory, HashMap<Integer, Riddle> riddles, Room currentRoom){
