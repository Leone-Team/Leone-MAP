...
public class TurnObserver implements GameObserver {
    ...
    public String update(Game game, ActionInGame actioningame) {
        ...
        Boolean rightCmds = actioningame.getCommand().getType() == CommandType.TURN_ON || actioningame.getCommand().getType() == CommandType.TURN_OFF || actioningame.getCommand().getType() == CommandType.WEAR;
